...
UUID=${UUID:-'05ba43b3-e9b9-42c8-83a1-a55ef20f7f69'}
VMESS_WSPATH=${VMESS_WSPATH:-'/05ba43b3-e9b9-42c8-83a1-a55ef20f7f69-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/05ba43b3-e9b9-42c8-83a1-a55ef20f7f69-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/05ba43b3-e9b9-42c8-83a1-a55ef20f7f69-trojan'}
SS_WSPATH=${SS_WSPATH:-'/05ba43b3-e9b9-42c8-83a1-a55ef20f7f69-shadowsocks'}
